						...
						<div class="col-md-4 col-xs-6">
							<div class="product">
								...
								<div class="add-to-cart">
									<a class="button button-primary-2 button-zakaria fl-bigmug-line-shopping202" href="form-cliente.php"><button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Add. ao Carrinho</button></a>
								</div>
							</div>
						</div>
						<!-- /product -->
